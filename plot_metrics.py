...
def plot_metrics():
    ...
    labels = [
        "0: Honest Bertrand (Max->Markdown)",
        "1: Adaptive Best-Response",
        "2: Dynamic Margin Track",
        "3: Strategic Undercut",
        "4: Evasive Target Price",
        "5: Camouflaged Cover",
        "6: Tacit Focal Point",
    ]
    ...
    ax3.stackplot(
        df["iteration"],
        *[df[s] for s in available_strats],
